...
void enviar_archivo(char auxiliar[300])											//Función que envía el archivo cuyo nombre se pasa en su argumento
{
	...
	char doc[]={"/home/pi/Desktop/Archivos/libreria/RaspberryPi-ADC-DAC/build"};	//Arreglo con la ruta donde se encuentran los archivos a enviar
...
void ultimo()																	//Función que envía el último archivo creado
{
	...
	char cadena[]={"find /home/pi/Desktop/Archivos/libreria/RaspberryPi-ADC-DAC/build/ -type f -wholename \"*00"};	//Arreglo con el comando y la ruta donde buscaremos el archivo
    ...
    {
			system("find /home/pi/Desktop/Archivos/libreria/RaspberryPi-ADC-DAC/build/ -type f -name \"*000-*\" >/home/pi/Desktop/Archivos/telegrambot/telebot-master/test/test/resultado.txt");	//Ejecutamos el comando find que buscará el archivo 
...
void ultimos10()																//Función que envía los 10 archivos más nuevos
{
	...
	{
		char cadena[]={"find /home/pi/Desktop/Archivos/libreria/RaspberryPi-ADC-DAC/build/ -type f -wholename \"*00"};		//Areglo con el comando y la ruta donde buscaremos el archivo
		...
		{																		//numérico, en caso de que exista 
			system("find /home/pi/Desktop/Archivos/libreria/RaspberryPi-ADC-DAC/build/ -type f -name \"*000-*\" >/home/pi/Desktop/Archivos/telegrambot/telebot-master/test/test/resultado.txt");	//Búsqueda del archivo '000' y su nombre y ruta se guardan
...
{																				//10 archivos siguientes o los 10 anteriores
	...
	char oldest[]={"find /home/pi/Desktop/Archivos/libreria/RaspberryPi-ADC-DAC/build/ -type f -wholename \"*00"};	//Arreglo con el comando y la ruta donde buscaremos el archivo
	...
	for(i_parcial3=0;i_parcial3<10;i_parcial3++)								//Bucle for que enviará los nombres de los 10 archivos
	{
        ...
        if(number_file2==0)														//Si number_file2=0 se debe buscar y enviar el nombre del archivo '000'
		{
			...
			system("find /home/pi/Desktop/Archivos/libreria/RaspberryPi-ADC-DAC/build/ -type f -name \"*000-*\" >/home/pi/Desktop/Archivos/telegrambot/telebot-master/test/test/resultado.txt");	//Búsqueda del archivo '000'
		...
		strcat(aux_name2,"\n\n");											//Concatenación de dos saltos de linea
			...
			{																	//y ya se enviaron todos los archivos
				if(i_parcial3!=9)												//Si el archivo número 0 no es el último archivo a enviar
				{
					...
					{	
						char cadena2[]={"find /home/pi/Desktop/Archivos/libreria/RaspberryPi-ADC-DAC/build/ -type f -wholename \"*00"};	//Cadena auxiliar 2
...
////////////////////////////////Bucle principal/////////////////////////////////   
	while (1)
    {
        char cadena_main[]={"find /home/pi/Desktop/Archivos/libreria/RaspberryPi-ADC-DAC/build/ -type f -wholename \"*"};		//Arreglo con el comando y la ruta donde buscaremos el archivo
        ret = telebot_get_updates(handle, offset, 20, 0, update_types, 0, &updates, &count);//Obtención de actualizaciones (mensajes entrantes)	
