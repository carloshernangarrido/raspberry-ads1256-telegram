...
int archivo()																	//Función para obtener el nombre del archivo a generar
{
	...
	char cadena1[400]={"rm -f ./home/pi/Desktop/Archivos/libreria/RaspberryPi-ADC-DAC/build/*"};													//Arreglo con sintaxis inicial del comando rm
	char end_route[]={"/home/pi/Desktop/Archivos/libreria/RaspberryPi-ADC-DAC/build/"};
